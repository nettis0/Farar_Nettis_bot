...
SCHEDULE = [
    ...
    (2, time(9, 25), time(10, 5)),
    (3, time(10, 20), time(11, 0)),
    (4, time(11, 15), time(11, 55)),
    (5, time(12, 10), time(12, 50)),
    (6, time(13, 0), time(13, 40)),
    (7, time(14, 0), time(14, 40)),
    (8, time(14, 55), time(15, 35)),
    (9, time(15, 50), time(16, 30)),
]
